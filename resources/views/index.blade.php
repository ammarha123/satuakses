...
@section('content')
    <div class="hero position-relative">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap">
            ...
            <a href="{{ route('lowongan.index') }}" class="btn btn-light px-4 py-2">Lihat Lowongan</a>
        </div>
    ...
    <div class="container main-content">
            ...
            @foreach ($lowongans as $lowongan)
                <div class="col-md-4 mb-3">
                    <div class="border p-3 rounded">
                        ...
                        <a href="{{ route('lowongan.detail', $lowongan->slug) }}" class="btn btn-primary">
                            Lihat Detail
                        </a>
                    </div>
                </div>
        ...
        <a href="{{ route('lowongan.index') }}" class="text-primary mt-3 d-inline-block">Lihat lainnya ...</a>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body position-relative">
                            ...
                            <p class="text-muted small mb-3">Pelatihan {{ $course->tingkat }}</p>
                            <a href="{{ route('kursus.show', $course->slug) }}" class="btn btn-outline-dark btn-sm">
                                Lihat Detail
                            </a>
                            <a href="{{ route('kursus.show', $course->slug) }}" class="stretched-link"
                                aria-label="Lihat detail {{ $course->judul }}"></a>
                        </div>
                    </div>
                </div>
            @endforeach
